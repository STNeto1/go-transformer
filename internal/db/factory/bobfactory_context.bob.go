...
var (
	// Relationship Contexts for input_files
	inputFileWithParentsCascadingCtx = newContextual[bool]("inputFileWithParentsCascading")

	// Relationship Contexts for pipelines
	pipelineWithParentsCascadingCtx = newContextual[bool]("pipelineWithParentsCascading")
)
